...
#define gui.main_menu_background = "gui/main_menu.png" # added video version intro
define gui.main_menu_background = Movie(play="gui/main_menu.mpg") # source open ai sora video gen
